...
AiOffice structural edits address semantic nodes, not array positions. The dev31
...
node. For an imported DOCX, dev31 accepts new `paragraph`, `heading`, `page_break`,
...
and proves header/footer semantics together; dev31 does not approximate it.
