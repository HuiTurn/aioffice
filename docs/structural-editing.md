...
AiOffice structural edits address semantic nodes, not array positions. The dev30
...
node. For an imported DOCX, dev30 accepts new `paragraph`, `heading`, `page_break`,
...
and proves header/footer semantics together; dev30 does not approximate it.
